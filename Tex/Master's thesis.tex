...
I would argue that it is natural to look at the valuation of real option analysis with the optics of stochastic decision theory. The reason why this relation between ROA and SDT was studied only marginally by authors like Vollert \cite{Vol:03} and ... has in my opinion two parts. \footnote{Or why nobody has ever done this? I do believe it is a natural thing to do...}

First is that ROA is not precisely defined, as discussed in the section \ref{sec:ROA}. There is no formal definition of ROA and its usage is mostly focused on showing that further management of projects can lead to significant increase in project's value, which should be recognized in the decision making of undergoing the initial investment.  Without a proper definition of the phrase \textit{Real Option Analysis} a deeper look at its meaning is more complicated. 

Second unfortunate reason is the relative closedness of scientific communities. Stochastic decision control theory focuses mostly on applications in engineering \cite{ChaManNou:16} or \cite{BorFigAze:17}, game theory, ... in their established communities. As far as I know, the stochastic decision theory was not used to value project in correspondence with the economical theory - respecting arbitrage principle, usual discounting, etc.  \footnote{Really nobody valued project with a SDT before??? Without a replicating portfolio, there is no arbitrage principle, and the ROA is effectively only the ability to change the course of a project... Nobody has done this?} The communities of economists and stochastic decision theory scholars probably does not have a large enough intersection to spawn the, in my opinion, natural idea of interpretation of ROA in terms of SDT. 
...
The usage of the term risk varies widely in the literature. In the spoken English the meaning of risk is the possibility of something bad happening. In parts of SDT, namely \cite{DeG:04}, the meaning of risk means the minimal expected loss. In parts of business administration \footnote{Podnikova ekonomika} \cite{Kni:21} risk means uncertainty that cannot be modeled. 

In economical books \cite{BerDeM:09} or \cite{} the risk is understood as uncertainty of investment returns. Risk in these publications is understood as volatility - standard deviation of the profit performances of individual asset types. 

In correspondence to the focus of this thesis on project valuation the view of economical theory makes the most sense and it will be further discussed. 

Historical records of the returns for different types of investments in \cite{BerDeM:09} show that there is almost linear dependency between an investment's volatility and its returns. This observation is made only on a small sample of easily distinguishable investment opportunities: Treasury bills, Corporate bonds and three stock portfolios: World stocks, small stocks and S\&P 500. 

In spite of the small sample of options, these investment opportunities cover a majority of the classical financial investments in non-derivative markets. 

The conclusion of this observation is that investors are risk-averse and the more volatility an investment has, the more returns they require. If the market constituted only from risk-neutral participants, there is no reason why more volatile assets should have returns in multiples of others. 

The idea of risk-averse decision makers is again familiar to the stochastic decision theory. The concept of utility takes into account exactly this human behavior, being more averse towards loss of the same nominal value than keen on profit. 

The second part of the uncertainty specific for investments is their correlation with the overall market. An asset that has a negative correlation to the overall economy, for example food companies <Example1> or gold mining companies <Example2> can be understood as a hedge against the negative trends in the overall market and people are willing to pay more for such assets. 

This is where the notion of risk-premiums comes in. The assets that are perfectly correlated with the market tend to have higher returns, since the investors require high risk-premiums on that asset. On the other hand, assets with negative correlation to the market are understood as tools for hedging and have generally lower requested return rates. 

To incorporate the influence of correlation with the market on the utility of individual asset the utility function needs to be 2-dimensional. 

\begin{example}
	<Utility function 2D> 
\end{example}

It can be seen from the example, that in computation of individual utilities for one asset there is always the same correlation with the market. Thus, when there is a small number of branches in the valued project one can understand the utility function not as two-dimensional, but as multiple 1D utility functions, for example denoted with subscripts $U_{CB}$ and $U_{Oil}$. 



\section{Time value of money}
Due to the belief of the majority of national central banks in the theory of ... the optimal target inflation is set to be around 2\%. This rate, the theory says, is the optimal for people to not delay purchases and investments, and incentives them to purchase goods and services now. The consequence of a non-zero requested inflation rate is the concept of time value of money. 

It is a well known fact that 1000 USD now does not have the same value as 1000 USD next year. When we are talking about the time value of money two rates are important.

 First, what is the risk-free rate that the investor is able to get if he invest the money he currently owns. This type of return is usually determined by the rate with which the government bonds are issued. This rate determines the minimal appreciation of already held money. This rate is generally expected to be positive, but as the recent unprecedented events show also negative. The negative interest rates were presented by a central banks of: Japan (20xx, -0.5\%), Germany (20xx -0.x\%) and Switzerland (20xx -0.5\%) with the intention to support the economy with offer of cheaper loans from commercial banks. \footnote{Not sure about this, needs to be checked.}

The second important interest rate is the one for which the investor can borrow in commercial banks, or other institutions and individuals. This interest rate is a function of many variables, such as the amount of borrowed money, the credibility and valuation of the investor and also risk of the project. With the assumption of risk-neutral creditors and no fixed costs associated with the process of lending money, the only relevant factor for creditors to obtain a given expected return is the debtor's probability of default.

The rate at which a project's investor is able to borrow may vary significantly. There is only a small risk of default of a large bank or already established energetic company which can guarantee for the loan with their other assets. On the other hand a small startup, with no guarantee and a risky project has a significantly higher probability of default and thus to increase the average expected return for a creditor, the interest rate of the loan needs to be higher. 


In this section I argue that the discount factor for valuation of given FCF vector is individual for each company and that it can be computed as a weighted average of the two aforementioned rates based on the level of self financing. The following formula

\begin{equation}
	r
\end{equation}

This formula reflects the idea that the money company already has could 


The discussion about the limits of time value of money is also interesting. The time value of money can be interpreted as being indifferent to having some amount of money now to having a different amount of money later. For example, assume the interest rate is 5\%, then one cannot be indifferent to having a 100 USD now and 103 USD the next year, since the 100 can be turned to 105 USD with no risk. Thus there exists an upper limit of money one can be indifferent to obtaining now versus obtaining a firm amount next year. 

There also exists a theoretical lower bound of such indifference. One also cannot value the 105 USD obtained in the future lower than some value $x = 105/r$ where $r$ is the interest rate one is able to get from a creditors. One cannot be indifferent to having less than $105/r$ now and 105 next year, since the choice of 105 next year would allow one to borrow $x_2<105/r$, obtain 105 next year and keep the difference. The lower bound comes as a consequence of a possibility to borrow money and absence of arbitrage. 
