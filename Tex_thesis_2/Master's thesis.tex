...
\noindent \emph{Abstract:} \textbf{<Investments now are done with algorithms and economical theorems> 
	<Most used is a simple NPV technique, but it does not take into account the value of the future possibility of altering the project> 
	<The theory of real options analysis (ROA) tries to incorporate the value of such options within the economical framework> 
	<The current ROA techniques have problem to cover more complex valuation problems, because they have limited abiility to incorporate multiple uncertain variables and different types of possible actions> 
	< This thesis takes the problem of ROA and tries to interpret it as a problem of decision making under unceratainty, while keeping the economical truths like time value of money and risk-aversion of investors> 
	<SDT field is more mathematically rigorous and its decades of focus bring a lot to work with> 
	<In this thesis we present a valuation algorithm that builds on the knowledge of SDT, covers the solutions that are being made by ROA and preserves the economical truths mentioned above> 
	<We demonstrate the usage of the algoirithm on a specific example of valuation of a gas power plant, where the problem of uncountable state space is solved by the approximate dynamic programming technique of value function approximation, where we use piecewise linear models, to cover their option-like structure> 
...
The publicity and wide adoption of the BSM model most likely inspired an expert on capital budgeting, Stewart Myers, to introduce the term "Real Options" \cite{Mye:77}, one of two main pillars of this thesis. Myers builds on the idea that part of the project's value is hidden in the form of real options - the ability to change the course of the project in the future. Myers' approach to the real options is mostly philosophical in the sense that he stresses out the importance of thinking about the additional value options bring. At the same time he does not present any computational tool for the said value. 
